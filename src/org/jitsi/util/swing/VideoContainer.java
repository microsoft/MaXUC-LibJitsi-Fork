    ...
    extends TransparentPanel
{
    ...
    private void onContainerEvent(ContainerEvent ev)
    {
        try
        {
            ...
            /*
             *An explicit background color is to be displayed by this Component
             * so make sure that its opaque property i.e. transparency does not
             * interfere with that display.
             */
