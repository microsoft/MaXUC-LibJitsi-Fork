    ...
    extends PropertyChangeNotifier
{
     ...
     */
    private final Object captureDeviceLock = new Object();
    ...
    private static VideoFormat assertSize(VideoFormat sourceFormat)
    {
        ...
        // H.263
        if (sourceFormat.matches(new Format(VideoFormat.H263_RTP)))
        {
...
//            }
    ...
    private void closeProcessor()
    {
        if (processor != null)
        {
            ...
            processor.stop();
            logger.trace("Stopped Processor with hashCode "
                            + processor.hashCode());
    ...
    protected Player createPlayer(DataSource dataSource)
    {
        ...
        else if (player != null)
        {
            ...
            player.configure();
            logger.trace("Created Player with hashCode "
                            + player.hashCode()
                            + " for "
                            + MediaStreamImpl.toString(dataSource));
        }
    ...
    protected Processor createProcessor()
    {
        ...
        if (captureDevice != null)
        {
            ...
            {
                logger.debug("Processor is " + processor + " for device " +
                                     captureDevice);
                if (processorControllerListener == null)
    ...
    public void setFormat(MediaFormat format)
    {
        ...
        logger.trace("Set format " + this.format
                        + " on "
