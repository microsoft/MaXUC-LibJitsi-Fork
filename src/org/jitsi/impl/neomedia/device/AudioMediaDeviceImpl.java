    ...
    protected Renderer createRenderer()
    {
        ...
        try
        {
            ...
            if (locatorProtocol != null)
            {
                ...
                if (audioSystem != null)
                {
                    // If the renderer differentiates between blocking and non-blocking behaviour,
                    // choose non-blocking behaviour for playback of audio in a call.
                    renderer = audioSystem.createRenderer(true, false);
                }
            }
        }
        finally
