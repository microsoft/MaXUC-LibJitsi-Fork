    ...
    implements MediaDeviceWrapper
{
     ...
     *
     * @throws IllegalArgumentException if device cannot capture.
     *
    ...
    private void fireLocalUserAudioLevelChanged(int level)
    {
         ...
         */
        for (SimpleAudioLevelListenerWrapper listenerWrapper : localUserAudioLevelListeners)
        {
            listenerWrapper.listener.audioLevelChanged(level);
        }
    }
        ...
        implements PropertyChangeListener
    {
         ...
         * that this "secondary session" encapsulates. This class does not keep a
