...
{
    private static final Logger sLog = Logger.getLogger(SpeexResampler.class);
    ...
    public SpeexResampler()
    {
        ...
        sLog.info("Created SpeexResampler " + this);
    ...
    protected int doProcess(Buffer inBuffer, Buffer outBuffer)
    {
        ...
        else
        {
            ...
            int newSize = outSampleCount * frameSize + outOffset;
            byte[] out = validateByteArraySize(outBuffer, newSize, outOffset != 0);
            ...
            {
                outSampleCount = 0;
                sLog.warn("Asked to sample 0 frames, inLength was " +
                                      inLength + " and frameSize " + frameSize);
            }
            else
            {
                ...
                // Work out how many bytes of the inBuffer have been consumed
                // by this process
                ...
                if (inLength < 0)
                {
                    sLog.warn("Resampled length is negative " +
                                       inLength + ", resmaple is " + resampled);
                    inLength = 0;
                }
