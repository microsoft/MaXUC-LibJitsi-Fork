...
//TODO:                if( ( base_Q32 >> 16 ) != 0 ) {
    ...
    )
    {
        ...
        mem.SKP_Silk_range_enc_wrap_up_tmp_int[0] = 0;
        bits_in_stream = SKP_Silk_range_coder_get_length( psRC, mem.SKP_Silk_range_enc_wrap_up_tmp_int );
        nBytes = mem.SKP_Silk_range_enc_wrap_up_tmp_int[0];
...
//        base_Q24 &= 0xFFFFFFFF << ( 24 - bits_to_store );
    ...
    )
    {
        ...
        int nBytes_ptr[] = mem.zero(mem.SKP_Silk_range_coder_check_after_decoding__nBytes_ptr);
