...
public class ControlCodecFLP {
    ...
    )
    {
        ...
        if( psEnc.sCmn.fs_kHz != fs_kHz || psEnc.sCmn.prev_API_fs_Hz != API_fs_Hz )
        {
            ...
            SigProcFLP.SKP_float2short_array( x_bufFIX, psEnc.x_buf, 2 * Define.MAX_FRAME_LENGTH + Define.LA_SHAPE_MAX );
            ...
            if( fs_kHz * 1000 < API_fs_Hz && psEnc.sCmn.fs_kHz != 0 )
            {
                ...
                ret += Resampler.SKP_Silk_resampler( temp_resampler_state, x_buf_API_fs_Hz,0, x_bufFIX,0, nSamples_temp, mem );
            ...
            if( 1000 * fs_kHz != API_fs_Hz )
            {
                ...
                ret += Resampler.SKP_Silk_resampler( psEnc.sCmn.resampler_state, x_bufFIX,0, x_buf_API_fs_Hz,0, nSamples_temp, mem );
            }
        ...
        else if( Complexity == 1 )
        {
            ...
            psEnc.noiseShapingQuantizerCB          = mem.SKP_Silk_control_encoder_FLP__NSQImplNSQDelDec;
            psEnc.sCmn.useInterpolatedNLSFs        = 0;
...
class NSQImplNSQ implements NoiseShapingQuantizerFP
{
    public void NoiseShapingQuantizer(SKP_Silk_encoder_state psEnc,
            ...
            int arg14, int arg15, EncodeMem mem) {
        NSQ.SKP_Silk_NSQ(psEnc, psEncCtrl, nsq, x, q, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, mem);
    }
}
...
class NSQImplNSQDelDec implements NoiseShapingQuantizerFP
{
    public void NoiseShapingQuantizer(SKP_Silk_encoder_state psEnc,
            ...
            short[] arg9, int[] arg10, int[] arg11, int[] arg12, int[] arg13,
            int arg14, int arg15, EncodeMem mem) {
        NSQDelDec.SKP_Silk_NSQ_del_dec(psEnc, psEncCtrl, NSQ, x, q, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, mem);
    }
}
