...
public class DecodeParameters
{
        ...
        )
    {
        ...
        int[]   NLSFIndices = mem.zero(mem.SKP_Silk_decode_parameters__NLSFIndices);
        int[]   pNLSF_Q15 = mem.zero(mem.SKP_Silk_decode_parameters__pNLSF_Q15);
        int[]   pNLSF0_Q15 = mem.zero(mem.SKP_Silk_decode_parameters__pNLSF0_Q15);
        short[] cbk_ptr_Q14;
        ...
        /* Dequant Gains */
        mem.SKP_Silk_decode_parameters__tmp_int[0] = psDec.LastGainIndex;
        GainQuant.SKP_Silk_gains_dequant( psDecCtrl.Gains_Q16, GainsIndices, mem.SKP_Silk_decode_parameters__tmp_int, psDec.nFramesDecoded );
        psDec.LastGainIndex = mem.SKP_Silk_decode_parameters__tmp_int[0];
        ...
        /************************************/
        mem.SKP_Silk_decode_parameters__tmp_int[0] = psDecCtrl.NLSFInterpCoef_Q2;

        RangeCoder.SKP_Silk_range_decoder( mem.SKP_Silk_decode_parameters__tmp_int, 0, psRC, TablesOther.SKP_Silk_NLSF_interpolation_factor_CDF, 0,
                TablesOther.SKP_Silk_NLSF_interpolation_factor_offset );
        psDecCtrl.NLSFInterpCoef_Q2 = mem.SKP_Silk_decode_parameters__tmp_int[0];
        ...
        if( fullDecoding !=0) {
            ...
            NLSF2AStable.SKP_Silk_NLSF2A_stable( psDecCtrl.PredCoef_Q12[ 1 ], pNLSF_Q15, psDec.LPC_order, mem );
            if( psDecCtrl.NLSFInterpCoef_Q2 < 4 ) {
                ...
                /* Convert NLSF parameters to AR prediction filter coefficients */
                NLSF2AStable.SKP_Silk_NLSF2A_stable( psDecCtrl.PredCoef_Q12[ 0 ], pNLSF0_Q15, psDec.LPC_order, mem );
            } else {
...
//                SKP_Silk_range_decoder( &Ixs[ 1 ], psRC, SKP_Silk_pitch_contour_CDF, SKP_Silk_pitch_contour_CDF_offset );
            ...
            mem.SKP_Silk_decode_parameters__tmp_int[0] =  psDecCtrl.PERIndex;

            RangeCoder.SKP_Silk_range_decoder( mem.SKP_Silk_decode_parameters__tmp_int, 0,  psRC, TablesLTP.SKP_Silk_LTP_per_index_CDF, 0,
                    TablesLTP.SKP_Silk_LTP_per_index_CDF_offset );
            psDecCtrl.PERIndex = mem.SKP_Silk_decode_parameters__tmp_int[0];
        ...
        /*********************************************/
        DecodePulses.SKP_Silk_decode_pulses( psRC, psDecCtrl, q, psDec.frame_length, mem );

        /*********************************************/
        /* Decode VAD flag                           */
        /*********************************************/
        mem.SKP_Silk_decode_parameters__tmp_int[0] = psDec.vadFlag;
        RangeCoder.SKP_Silk_range_decoder( mem.SKP_Silk_decode_parameters__tmp_int, 0, psRC, TablesOther.SKP_Silk_vadflag_CDF, 0, TablesOther.SKP_Silk_vadflag_offset );
        psDec.vadFlag = mem.SKP_Silk_decode_parameters__tmp_int[0];

        /**************************************/
        /* Decode Frame termination indicator */
        /**************************************/
        mem.SKP_Silk_decode_parameters__tmp_int[0] = psDec.FrameTermination;
        RangeCoder.SKP_Silk_range_decoder( mem.SKP_Silk_decode_parameters__tmp_int, 0, psRC, TablesOther.SKP_Silk_FrameTermination_CDF, 0, TablesOther.SKP_Silk_FrameTermination_offset );
        psDec.FrameTermination = mem.SKP_Silk_decode_parameters__tmp_int[0];

        /****************************************/
        /* get number of bytes used so far      */
        /****************************************/
        mem.SKP_Silk_decode_parameters__tmp_int[0] = 0;
        RangeCoder.SKP_Silk_range_coder_get_length( psRC, mem.SKP_Silk_decode_parameters__tmp_int );
        nBytesUsed = mem.SKP_Silk_decode_parameters__tmp_int[0];
        ...
        /****************************************/
        if( psDec.nBytesLeft == 0 ) {
            RangeCoder.SKP_Silk_range_coder_check_after_decoding( psRC, mem );
        }
    }
}
