...
public class Lin2log
{
     ...
     * @return
     */
    static int SKP_Silk_lin2log(
        final int       inLin,          /* I:    Input in linear scale */
        final EncodeMem mem
    )
    {
        int lz, frac_Q7;

        int[] lz_ptr = mem.zero(mem.SKP_Silk_lin2log__lz_ptr);
        int[] frac_Q7_ptr = mem.zero(mem.SKP_Silk_lin2log__frac_Q7_ptr);
