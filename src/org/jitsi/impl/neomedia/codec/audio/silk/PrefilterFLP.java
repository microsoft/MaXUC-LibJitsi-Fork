...
public class PrefilterFLP
{
    ...
    )
    {
        ...
        float[] B = mem.zero(mem.SKP_Silk_prefilter_FLP__B);
        float[] AR1_shp = mem.zero(mem.SKP_Silk_prefilter_FLP__AR1_shp);
        float[] px;
        int px_offset;
        float[] pxw, pst_res;
        int pxw_offset;
        int pst_res_offset;
        float[] HarmShapeFIR = mem.zero(mem.SKP_Silk_prefilter_FLP__HarmShapeFIR);
        float[] st_res = mem.zero(mem.SKP_Silk_prefilter_FLP__st_res);
