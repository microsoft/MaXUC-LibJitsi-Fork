...
public class BurgModifiedFLP
{
    ...
    )
    {
        ...
        float []x_ptr;
        int x_ptr_offset;
        double[] C_first_row = mem.zero(mem.SKP_Silk_burg_modified_FLP__C_first_row);
        double[] C_last_row = mem.zero(mem.SKP_Silk_burg_modified_FLP__C_last_row);
        double[] CAf = mem.zero(mem.SKP_Silk_burg_modified_FLP__CAf);
        double[] CAb = mem.zero(mem.SKP_Silk_burg_modified_FLP__CAb);
        double[] Af = mem.zero(mem.SKP_Silk_burg_modified_FLP__Af);
