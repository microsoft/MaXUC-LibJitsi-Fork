...
public class CodeSigns
{
    ...
    )
    {
        int i;
        int inData;
        int[] cdf = mem.zero(mem.SKP_Silk_encode_signs__cdf);
        ...
        )
    {
        int i;
        int data;
        int data_ptr[] = mem.zero(mem.SKP_Silk_decode_signs__data_ptr);
        int[] cdf = mem.zero(mem.SKP_Silk_decode_signs__cdf);
