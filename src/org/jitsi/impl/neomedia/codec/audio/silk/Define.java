...
public class Define
{
    ...
    static final int PITCH_EST_COMPLEXITY_HC_MODE =           SigProcFIX.SKP_Silk_PITCH_EST_MAX_COMPLEX;
    static final int PITCH_EST_COMPLEXITY_MC_MODE =           SigProcFIX.SKP_Silk_PITCH_EST_MID_COMPLEX;
    static final int PITCH_EST_COMPLEXITY_LC_MODE =           SigProcFIX.SKP_Silk_PITCH_EST_MIN_COMPLEX;
