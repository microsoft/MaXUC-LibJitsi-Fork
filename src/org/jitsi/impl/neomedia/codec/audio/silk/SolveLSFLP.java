...
public class SolveLSFLP
{
    ...
    {
        int i;
        float[] L_tmp = mem.zero(mem.SKP_Silk_solve_LDL_FLP__L_tmp);
        float[] T = mem.zero(mem.SKP_Silk_solve_LDL_FLP__T);
        // Inverse diagonal elements of D.
        float[] Dinv = mem.zero(mem.SKP_Silk_solve_LDL_FLP__Dinv);
        ...
        ****************************************************/
        SKP_Silk_LDL_FLP(A, A_offset, M, L_tmp, Dinv, mem );
...
//            ptr1 =  matrix_adr( L, i, 0, M );
    ...
    )
    {
        ...
        float[] v = mem.zero(mem.SKP_Silk_LDL_FLP__v);
        float[] D = mem.zero(mem.SKP_Silk_LDL_FLP__D);
