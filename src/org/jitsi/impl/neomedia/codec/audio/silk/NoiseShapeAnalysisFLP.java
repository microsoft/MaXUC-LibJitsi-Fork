...
public class NoiseShapeAnalysisFLP
{
    ...
    )
    {
        ...
        float[]   x_windowed = mem.zero(mem.SKP_Silk_noise_shape_analysis_FLP__x_windowed);
        float[]   auto_corr = mem.zero(mem.SKP_Silk_noise_shape_analysis_FLP__auto_corr);
        ...
        for( k = 0; k < Define.NB_SUBFR; k++ )
        {
            ...
            AutocorrelationFLP.SKP_Silk_autocorrelation_FLP(auto_corr, x_windowed, Define.SHAPE_LPC_WIN_MS * psEnc.sCmn.fs_kHz, psEnc.sCmn.shapingLPCOrder + 1);
            ...
            LPC_fit_int16( psEncCtrl.AR2,k * Define.SHAPE_LPC_ORDER_MAX, 1.0f, psEnc.sCmn.shapingLPCOrder, 3.999f, mem );
...
//                psEnc->sCmn.shapingLPCOrder * sizeof( SKP_float ) );
            ...
            mem.SKP_Silk_noise_shape_analysis_FLP_float_tmp[0] = pre_nrg;
            LPCInvPredGainFLP.SKP_Silk_LPC_inverse_pred_gain_FLP( mem.SKP_Silk_noise_shape_analysis_FLP_float_tmp, psEncCtrl.AR2,k * Define.SHAPE_LPC_ORDER_MAX, psEnc.sCmn.shapingLPCOrder, mem );
            pre_nrg = mem.SKP_Silk_noise_shape_analysis_FLP_float_tmp[0];
            mem.SKP_Silk_noise_shape_analysis_FLP_float_tmp[0] = nrg;
            LPCInvPredGainFLP.SKP_Silk_LPC_inverse_pred_gain_FLP( mem.SKP_Silk_noise_shape_analysis_FLP_float_tmp, psEncCtrl.AR1,k * Define.SHAPE_LPC_ORDER_MAX, psEnc.sCmn.shapingLPCOrder, mem );
            nrg = mem.SKP_Silk_noise_shape_analysis_FLP_float_tmp[0];
    ...
    )
    {
        ...
        int     k, i, idx = 0;
        float[]   invGain = mem.zero(mem.LPC_fit_int16__invGain);
        ...
        for( k = 0; k < 1000; k++ )
        {
            if( LPCInvPredGainFLP.SKP_Silk_LPC_inverse_pred_gain_FLP( invGain, a,a_offset, L, mem ) == 1 )
            {
