...
public class ResamplerRom
{
    ...
    static final short[] SKP_Silk_resampler_up2_hq_0 = {  4280, (short) 33727 };
    static final short[] SKP_Silk_resampler_up2_hq_1 = { 16295, (short) 54015 };
    /* Matlab code for the notch filter coefficients: */
    /* B = [1, 0.12, 1];  A = [1, 0.055, 0.8]; G = 0.87; freqz(G * B, A, 2^14, 16e3); axis([0, 8000, -10, 1]);  */
    /* fprintf('\t%6d, %6d, %6d, %6d\n', round(B(2)*2^16), round(-A(2)*2^16), round((1-A(3))*2^16), round(G*2^15)) */
    static final short[] SKP_Silk_resampler_up2_hq_notch = { 7864,  -3604,  13107,  28508 };

    /* Tables with IIR and FIR coefficients for fractional downsamplers (70 Words) */
    static final short[] SKP_Silk_Resampler_3_4_COEFS =
    {
        -18249, -12532,
    ...
    static final short[] SKP_Silk_Resampler_2_3_COEFS =
    {
        -11891, -12486,
    ...
    static final short[] SKP_Silk_Resampler_1_2_COEFS =
    {
          2415, -13101,
           158,   -295,   -400,   1265,   4832,   7968,
    };

    static final short[] SKP_Silk_Resampler_3_8_COEFS =
    {
         13270, -13738,
    ...
    static final short[] SKP_Silk_Resampler_1_3_COEFS =
    {
         16643, -14000,
          -331,     19,    581,   1421,   2290,   2845,
    };

    static final short[] SKP_Silk_Resampler_2_3_COEFS_LQ =
    {
         -2797,  -6507,
          4697,  10739,
          1567,   8276,
    ...
    static final short[] SKP_Silk_Resampler_1_3_COEFS_LQ =
    {
         16777,  -9792,
           890,   1614,   2148,
    };
    ...
    static final short[] SKP_Silk_Resampler_320_441_ARMA4_COEFS =
    {
         31454,  24746,  -9706,  -3386, -17911, -13243,  24797
    };

    static final short[] SKP_Silk_Resampler_240_441_ARMA4_COEFS =
    {
         28721,  11254,   3189,  -2546,  -1495, -12618,  11562
    };

    static final short[] SKP_Silk_Resampler_160_441_ARMA4_COEFS =
    {
         23492,  -6457,  14358,  -4856,  14654, -13008,   4456
    };

    static final short[] SKP_Silk_Resampler_120_441_ARMA4_COEFS =
    {
         19311, -15569,  19489,  -6950,  21441, -13559,   2370
    };

    static final short[] SKP_Silk_Resampler_80_441_ARMA4_COEFS =
    {
         13248, -23849,  24126,  -9486,  26806, -14286,   1065
    };

    /* Table with interplation fractions of 1/288 : 2/288 : 287/288 (432 Words) */
    static final short[][] SKP_Silk_resampler_frac_FIR_144 =
    {
        { -647,  1884, 30078},
        { -625,  1736, 30044},
        { -603,  1591, 30005},
