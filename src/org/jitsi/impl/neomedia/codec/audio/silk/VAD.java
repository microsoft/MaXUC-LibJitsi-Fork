...
//      SKP_memset( psSilk_VAD, 0, sizeof( SKP_Silk_VAD_state ) );
    ...
    static final int[] tiltWeights = { 30000, 6000, -12000, -12000 };
    ...
    )
    {
        ...
        short[][] X = mem.zero(mem.SKP_Silk_VAD_GetSA_Q8__X);
        int[] Xnrg = mem.zero(mem.SKP_Silk_VAD_GetSA_Q8__Xnrg);
        int[] NrgToNoiseRatio_Q8 = mem.zero(mem.SKP_Silk_VAD_GetSA_Q8__NrgToNoiseRatio_Q8);
        ...
        AnaFiltBank1.SKP_Silk_ana_filt_bank_1( pIn,    psSilk_VAD.AnaState, X[ 0 ], X[ 3 ], framelength );

        /* 0-4 kHz to 0-2 kHz and 2-4 kHz */
        AnaFiltBank1.SKP_Silk_ana_filt_bank_1( X[ 0 ], psSilk_VAD.AnaState1, X[ 0 ], X[ 2 ], framelength>>1 );

        /* 0-2 kHz to 0-1 kHz and 1-2 kHz */
        AnaFiltBank1.SKP_Silk_ana_filt_bank_1( X[ 0 ], psSilk_VAD.AnaState2, X[ 0 ], X[ 1 ], framelength>>2 );
        ...
        for( b = 0; b < Define.VAD_N_BANDS; b++ )
        {
            ...
            if( speech_nrg > 0 )
            {
                ...
                SNR_Q7 = Lin2log.SKP_Silk_lin2log( NrgToNoiseRatio_Q8[ b ], mem ) - 8 * 128;
                ...
                if( speech_nrg < ( 1 << 20 ) ) {
                    ...
                    SNR_Q7 = Macros.SKP_SMULWB( Inlines.SKP_Silk_SQRT_APPROX( speech_nrg, mem ) << 6, SNR_Q7 );
                }
        ...
        pSNR_dB_Q7[0] = ( short )( 3 * Inlines.SKP_Silk_SQRT_APPROX( sumSquared, mem ) );  /* Q7 */
        ...
        {
            /* square-root */
            speech_nrg = Inlines.SKP_Silk_SQRT_APPROX( speech_nrg << 15, mem );
        ...
        for( b = 0; b < Define.VAD_N_BANDS; b++ )
        {
            ...
            SNR_Q7 = 3 * ( Lin2log.SKP_Silk_lin2log( psSilk_VAD.NrgRatioSmth_Q8[b], mem ) - 8 * 128 );
