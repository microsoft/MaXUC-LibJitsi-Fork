    ...
    )
    {
        ...
        if( action == 0 ) {
            ...
            if( psDec.sRC.error !=0 ) {
                ...
                /* Run inverse NSQ                                      */
                /********************************************************/
                DecodeCore.SKP_Silk_decode_core( psDec, sDecCtrl, pOut, pOut_offset, Pulses, mem );

                /********************************************************/
                /* Update PLC state                                     */
                /********************************************************/
                PLC.SKP_Silk_PLC( psDec, sDecCtrl, pOut, pOut_offset, action, mem );
        ...
        /****************************************************************/
        PLC.SKP_Silk_PLC_glue_frames( psDec, pOut, pOut_offset, L, mem );

        /************************************************/
        /* Comfort noise generation / estimation        */
        /************************************************/
        CNG.SKP_Silk_CNG( psDec, sDecCtrl, pOut , pOut_offset, L, mem );
