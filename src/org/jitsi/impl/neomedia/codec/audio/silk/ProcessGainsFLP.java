...
public class ProcessGainsFLP
{
    ...
    )
    {
        ...
        int     k;
        int[]   pGains_Q16 = mem.zero(mem.SKP_Silk_process_gains_FLP__pGains_Q16);
        ...
        mem.SKP_Silk_process_gains_FLP__tmp_int[0] = psShapeSt.LastGainIndex;
        GainQuant.SKP_Silk_gains_quant( psEncCtrl.sCmn.GainsIndices, pGains_Q16,
                mem.SKP_Silk_process_gains_FLP__tmp_int, psEnc.sCmn.nFramesInPayloadBuf, mem );
        psShapeSt.LastGainIndex = mem.SKP_Silk_process_gains_FLP__tmp_int[0];
