    ...
    implements PacketLossAwareEncoder
{
     ...
     * in nanosecond.
     */
    private final int duration = JavaDecoder.FRAME_DURATION * 1000000;
    ...
    public JavaEncoder()
    {
        ...
        //here.
        useFec = cfg.global().getBoolean(Constants.PROP_SILK_FEC, true);
        alwaysAssumePacketLoss
                = cfg.global().getBoolean(Constants.PROP_SILK_ASSUME_PL, true);

        //Update the statically defined value for "speech activity threshold"
        //according to our configuration
        String satStr = cfg.global().getString(Constants.PROP_SILK_FEC_SAT, "0.5");
        ...
        throws ResourceUnavailableException
    {
        ...
        mEncodeMem = new EncodeMem();
        encState = new SKP_Silk_encoder_state_FLP();
        encControl = new SKP_SILK_SDK_EncControlStruct();
        if (EncAPI.SKP_Silk_SDK_InitEncoder(encState, encControl, mEncodeMem) != 0)
        {
