...
public class TablesLTP
{
    ...
    static final int[] SKP_Silk_LTP_gain_CDF_offsets = {
             1,     3,     10
    };

    static final int SKP_Silk_LTP_gain_middle_avg_RD_Q14 = 11010;

    static final short[] SKP_Silk_LTP_gain_BITS_Q6_0 = {
            26,    236,    321,    325,    339,    344,    362,    379,
           412,    418
    };

    static final short[]  SKP_Silk_LTP_gain_BITS_Q6_1 = {
            88,    231,    237,    244,    300,    309,    313,    324,
           325,    341,    346,    351,    352,    352,    354,    356,
           367,    393,    396,    406
    };

    static final short[] SKP_Silk_LTP_gain_BITS_Q6_2 = {
