...
{
    static final int[] SKP_Silk_max_pulses_table = {
             6,      8,     12,     18
    };

    static final int[][] SKP_Silk_pulses_per_block_CDF  =
    {
    {
    ...
    static final short[][]  SKP_Silk_pulses_per_block_BITS_Q6  =
    {
    {
    ...
    static final int[][] SKP_Silk_rate_levels_CDF  =
    {
    {
    ...
    static final short[][] SKP_Silk_rate_levels_BITS_Q6  =
    {
    {
    ...
    static final int[] SKP_Silk_shell_code_table0 = {
    ...
    static final int[]  SKP_Silk_shell_code_table1 = {
    ...
    static final int[] SKP_Silk_shell_code_table2 = {
    ...
    static final int[] SKP_Silk_shell_code_table3 = {
    ...
    static final int[] SKP_Silk_shell_code_table_offsets = {
             0,      0,      3,      7,     12,     18,     25,     33,
