...
public class DetectSWBInput
{
    ...
    static void SKP_Silk_detect_SWB_input(
        ...
        {
            int     HP_8_kHz_len, i;
            int[]   shift = mem.zero(mem.SKP_Silk_detect_SWB_input__shift);
            int[]   energy_32 = mem.zero(mem.SKP_Silk_detect_SWB_input__energy_32);
            short[] in_HP_8_kHz = mem.zero(mem.SKP_Silk_detect_SWB_input__in_HP_8_kHz);
