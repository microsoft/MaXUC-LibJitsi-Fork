...
public class LPVariableCutoff
{
    ...
    {
        int[] B_Q28 = mem.zero(mem.SKP_Silk_LP_variable_cutoff__B_Q28);
        int[] A_Q28 = mem.zero(mem.SKP_Silk_LP_variable_cutoff__A_Q28);
        int fac_Q16 = 0;
        int     ind = 0;
