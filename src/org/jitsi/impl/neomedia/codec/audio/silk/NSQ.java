...
public class NSQ
{
    ...
    )
    {
        ...
        short   []pxq;
        int     pxq_offset;
        int[]   sLTP_Q16 = mem.zero(mem.SKP_Silk_NSQ__sLTP_Q16);
        short[] sLTP = mem.zero(mem.SKP_Silk_NSQ__sLTP);
        int     HarmShapeFIRPacked_Q14;
        int     offset_Q10;
        int[]   FiltState = mem.zero(mem.SKP_Silk_NSQ__FiltState);
        int[]   x_sc_Q10 = mem.zero(mem.SKP_Silk_NSQ__x_sc_Q10);
        ...
        short[] x_tmp        = mem.SKP_Silk_NSQ_wrapper_FLP__x_tmp;
        System.arraycopy(x, 0, x_tmp, 0, x.length);
        int x_tmp_offset     = 0;
        int q_offset         = 0;
        ...
        for( k = 0; k < Define.NB_SUBFR; k++ ) {
            ...
            SKP_Silk_noise_shape_quantizer( NSQ, psEncCtrlC.sigtype, x_sc_Q10, q, q_offset, pxq, pxq_offset,
