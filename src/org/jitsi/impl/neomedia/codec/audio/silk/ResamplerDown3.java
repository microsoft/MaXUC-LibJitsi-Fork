...
public class ResamplerDown3
{
    ...
    )
    {
        ...
        int[] buf = mem.zero(mem.SKP_Silk_resampler_down3__buf);
        int buf_ptr;
        ...
        while( true )
        {
            ...
            {
                /* Inner product */
                res_Q6 = Macros.SKP_SMULWB(         buf[ buf_ptr   ] + buf[ buf_ptr+5 ], ResamplerRom.SKP_Silk_Resampler_1_3_COEFS_LQ[ 2 ] );
                res_Q6 = Macros.SKP_SMLAWB( res_Q6, buf[ buf_ptr+1 ] + buf[ buf_ptr+4 ], ResamplerRom.SKP_Silk_Resampler_1_3_COEFS_LQ[ 3 ] );
                res_Q6 = Macros.SKP_SMLAWB( res_Q6, buf[ buf_ptr+2 ] + buf[ buf_ptr+3 ], ResamplerRom.SKP_Silk_Resampler_1_3_COEFS_LQ[ 4 ] );
