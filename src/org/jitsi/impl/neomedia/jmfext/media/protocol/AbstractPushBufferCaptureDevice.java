 ...
 */
public abstract class AbstractPushBufferCaptureDevice<E extends AbstractPushBufferStream<?>>
    ...
    implements CaptureDevice
{
     ...
     */
    private final AbstractBufferCaptureDevice<E> impl
        = new AbstractBufferCaptureDevice<>()
    {
        @Override
        ...
        /**
         * Overrides {@link AbstractBufferCaptureDevice#getControls()} to add controls specific to this
     ...
     */
    protected abstract E createStream(
            int streamIndex,
            FormatControl formatControl);
