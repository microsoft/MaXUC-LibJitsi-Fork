    ...
    extends DataSource
{
    ...
    /**
     * Use this method when disconnecting then connecting straight away.
     *
     * It is synchronized on this object, which prevents concurrency issues due
     * the same TranscodingDataSource being modified by other threads between
     * the disconnect() and connect(). E.g. calling start() before connect()
     * causes a NPE. See BUG-4259 for more details.
     */
