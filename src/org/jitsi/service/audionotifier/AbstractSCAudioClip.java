    ...
    implements SCAudioClip
{
    ...
    /**
     * Try rendering the sample without an output device, to test its validity.
     *
    ...
    {
        // Default implementation does nothing, as not all implementations
        // support render testing.
        return true;
    }
